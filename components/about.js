    ...
    return (
        <section id='about'>
            <div className='bg-white dark:bg-stone-950  px-20 md:px-52 pt-36'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-4 lg:gap-48 shadow-lg p-5 border rounded-xl'>
                    <div className='col-span-1 rounded-xl overflow-hidden shadow-2xl' >
                        <Image data-aos='fade-right' data-aos-delay='200' src={'/YGBM8705.JPG'} width={100} height={100} alt='profile' className='w-full h-full object-cover object-center aos-init' />
                    ...
                    <div className='col-span-1 self-center pt-5 lg:pt-0'>
                        <h1 data-aos='fade-left' data-aos-delay='200' className='font-bold text-center lg:text-left text-gray-400 text-xl md:text-3xl mb-5' >My Tech</h1>
                        <div className='grid grid-cols-3 lg:grid-cols-2 gap-2'>
                            <div className='w-15 h-15  overflow-hidden'>
                                <Image src={'/next-js-logo.png'} width={75} height={75} alt='nextjs' />
                            </div>
                            <div className='w-15 h-15 overflow-hidden'>
                                <Image src={'/tailwindcss.png'} width={75} height={75} alt='tailwind' />
                            </div>
                            <div className='w-15 h-15 overflow-hidden'>
                                <Image src={'/nodejs.png'} width={75} height={75} alt='nodejs' />
                            </div>
