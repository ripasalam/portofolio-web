...
const Footer = () => {
    return (
        <div className='w-full border border-t  grid grid-cols-1 md:grid-cols-2 pt-5  lg:pt-10 pb-10 mx-auto bg-white dark:bg-stone-950 dark:border-b dark:dark-stone-600 px-4 sm:px-20 shadow-md'>
